...
import '../common/k_key.dart';
import '../utlis/log_util.dart';
...
class HttpUtils {
  ...
  ///应用token
  static String? _token = Application.getStorage.read(Kkey.loginToken);
  ...
  static set token(String? value) {
    if (_token != value) {
      _token = value;
      if (_token == null) {
        Application.getStorage.remove(Kkey.loginToken);
      } else {
        Application.getStorage.write(Kkey.loginToken, _token);
      }
    }
  }
  ...
  static init(
    ...
    _proxy = proxy;
    _proxyip = proxyip;
    _token = Application.getStorage.read(Kkey.loginToken);
  }
